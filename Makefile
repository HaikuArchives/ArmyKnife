...
APP_MIME_SIG = application/x-vnd.armyknife
...
SRCS = \
	source/addonview.cpp \
	source/aklistview.cpp \
	source/albumpictureview.cpp \
	source/application.cpp \
	source/appview.cpp \
	source/appwindow.cpp \
	source/audioattribute.cpp \
	source/audioattributes.cpp \
	source/audioinfo.cpp \
	source/barberpole.cpp \
	source/createmimetypes.cpp \
	source/editorview.cpp \
	source/entryrefitem.cpp \
...
LOCALES = ca de en_AU en_GB en es fr fur id it ja nl pt ro ru sc sv tr
