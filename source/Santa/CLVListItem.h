...
class CLVListItem : public BListItem
{
	public:
		...
		*/
		...
		BRect ItemColumnFrame(int32 column_index, const ColumnListView* owner) const;
		float ExpanderShift(int32 column_index, const ColumnListView* owner) const;
		...
		inline bool ExpanderRectContains(BPoint where) const {return fExpanderButtonRect.Contains(where);}
		...
		virtual bool Editable(int32 column_index) const;
			//Note: this should only return TRUE for textual columns!
		virtual const char* EditInitialText(int32 column_index) const;
		virtual BPoint ColumnTextDrawPoint(int32 column_index, const ColumnListView* owner) const;
		virtual void GetEditingFont(int32 column_index, BFont* font, const ColumnListView* owner) const;
		virtual void EditCompleted(int32 column_index, const char* text, ColumnListView* owner);
